...
$_SESSION['email']=$num['EmailId'];
$_SESSION['odd2active'] = $num['OddTwoActive'];
$_SESSION['odd3active'] = $num['OddThreeActive'];
$_SESSION['odd5active'] = $num['OddFiveActive'];
